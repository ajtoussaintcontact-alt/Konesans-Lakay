...
1- Choisir une catégorie parmi : Histoire nationale, Géographie, Littérature haïtienne, Proverbes haïtiens, Folklore et Faits divers.

2- Lire la question affichée à l’écran.

3- Sélectionner une des 3 réponses proposées.

4- ✅ Bonne réponse → affichage d’une image culturelle en lien avec la question pour renforcer la mémoire.

   ❌ Mauvaise réponse → l’interface devient rouge et permet d’apprendre de l’erreur.

5- Progresser dans les niveaux, surveiller le temps ⏱ et comparer les scores.
...
# 
![Konesans Lakay demo](https://github.com/user-attachments/assets/22b6f65a-7467-4e4b-b024-4736122487e1)
